...
Depends: apt, cryptsetup-bin, dpkg, dracut-core, gir1.2-notify-0.7, grub2-common, kmod, libgtk-3-0t64 | libgtk-3-0, libtss2-tcti-device0t64 | libtss2-tcti-device0, mokutil, openssl, passwd, perl, pkexec, polkitd, psmisc, python3, python3-gi, sbsigntool, systemd, systemd-cryptsetup, tpm-udev, tpm2-tools, util-linux, xz-utils, zstd
